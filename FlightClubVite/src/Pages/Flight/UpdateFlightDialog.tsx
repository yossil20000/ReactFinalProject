...
import { FlightUpdate, IFlightUpdate, IFlightUpdateApi } from "../../Interfaces/API/IFlight";
...
function UpdateFlightDialog({value,onClose,onSave,open,...other}: UpdateFlightDialogProps) {
  ...
  const handleOnSave = async () => {
    console.log("UpdateReserationDialog/onSave", flightUpdate)
    let flight = new FlightUpdate();
    ...
    await updateFlight(flightUpdate as IFlightUpdateApi);
