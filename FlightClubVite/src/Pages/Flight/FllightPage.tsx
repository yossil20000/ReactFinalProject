...
return {_id: flight._id,_id_member: flight.member._id,description:flight.description,
...
const FlightPage = () => {
  ...
  return (
    ...
    <div className='header'><Typography variant="h6" align="center">Flight Page</Typography></div>
        <div className='main' style={{ overflow: 'auto' }}>
      <UpdateFlightDialog onClose={handleUpdateOnClose} value={flightUpdateIntitial} open={openFlightUpdate} onSave={handleUpdateOnSave}/>
