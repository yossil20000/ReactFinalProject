...
function VersionHistory({show=false} : IVersionHistoryProps) {
  ...
  const rows   = [
    ...
    {id: 44,version: "2.0.15.11",date: new Date(2025,1,11).getDisplayDate() , "description" : "Fix Report","known_bug": "Admin/Devices Device need to clear and reselect the device name"},    
