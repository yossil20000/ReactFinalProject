...
function VersionHistory({show=false} : IVersionHistoryProps) {
  ...
  const rows   = [
    ...
    {id: 66,version: "2.0.27.0",date: new Date(2026,1,24).getDisplayDate() , "description" : "User selection search also description, Add created date as sort","known_bug": "Admin/Devices Device need to clear and reselect the device name"},    
    {id: 67,version: "2.0.27.1",date: new Date(2026,1,31).getDisplayDate() , "description" : "Add Expense fiter by Memeber Pay and Eexpected","known_bug": "Admin/Devices Device need to clear and reselect the device name"},    
