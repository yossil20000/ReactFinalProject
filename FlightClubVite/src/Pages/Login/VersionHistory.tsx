...
function VersionHistory({show=false} : IVersionHistoryProps) {
  ...
  const rows   = [
    ...
    {id: 7,version: "2.0.7.0",date: new Date(2024,0,12).getDisplayDate() , "description" : "Transaction add Export, User account add table view, fix transaction DB, add balance history"  ,"known_bug": "Admin/Devices Device need to clear and reselect the device name"},
